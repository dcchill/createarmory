...
import net.createarmory.procedures.BarretRightclickedProcedure;
import net.createarmory.procedures.BarretItemInHandTickProcedure;
import net.createarmory.item.renderer.BarretItemRenderer;
...
public class BarretItem extends Item implements IAnimatable {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new BarretItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, BarretItemRenderer renderer) {
	...
	public void setupAnimationState(BarretItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BarretRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			BarretItemInHandTickProcedure.execute(world, entity, itemstack);
	}
}
