...
import net.createarmory.item.renderer.BarretLowerItemRenderer;
...
public class BarretLowerItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public BarretLowerItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new BarretLowerItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, BarretLowerItemRenderer renderer) {
	...
	public void setupAnimationState(BarretLowerItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
