...
import net.createarmory.item.renderer.BarretUpperItemRenderer;
...
public class BarretUpperItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public BarretUpperItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new BarretUpperItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, BarretUpperItemRenderer renderer) {
	...
	public void setupAnimationState(BarretUpperItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
