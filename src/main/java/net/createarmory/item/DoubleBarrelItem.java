...
import net.createarmory.procedures.DoubleBarrelRightclickedProcedure;
import net.createarmory.procedures.DoubleBarrelItemInHandTickProcedure;
import net.createarmory.item.renderer.DoubleBarrelItemRenderer;
...
public class DoubleBarrelItem extends Item implements IAnimatable {
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, DoubleBarrelItemRenderer renderer) {
	...
	public void setupAnimationState(DoubleBarrelItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		DoubleBarrelRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			DoubleBarrelItemInHandTickProcedure.execute(world, entity, itemstack);
	}
}
