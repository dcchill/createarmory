...
import net.createarmory.procedures.EmptyBarretRightclickedProcedure;
import net.createarmory.procedures.EmptyBarretItemInHandTickProcedure;
import net.createarmory.item.renderer.EmptyBarretItemRenderer;
...
public class EmptyBarretItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public EmptyBarretItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyBarretItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyBarretItemRenderer renderer) {
	...
	public void setupAnimationState(EmptyBarretItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyBarretRightclickedProcedure.execute(world, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			EmptyBarretItemInHandTickProcedure.execute(world, entity);
	}
}
