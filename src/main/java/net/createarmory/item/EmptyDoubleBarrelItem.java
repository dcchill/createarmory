...
import net.createarmory.procedures.EmptyDoubleBarrelRightclickedProcedure;
import net.createarmory.procedures.EmptyDoubleBarrelItemInHandTickProcedure;
import net.createarmory.item.renderer.EmptyDoubleBarrelItemRenderer;
...
public class EmptyDoubleBarrelItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public EmptyDoubleBarrelItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyDoubleBarrelItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyDoubleBarrelItemRenderer renderer) {
	...
	public void setupAnimationState(EmptyDoubleBarrelItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyDoubleBarrelRightclickedProcedure.execute(world, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			EmptyDoubleBarrelItemInHandTickProcedure.execute(world, entity);
	}
}
