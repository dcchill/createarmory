...
import net.createarmory.procedures.EmptyMFourItemInHandTickProcedure;
import net.createarmory.procedures.EmptyFourSixteenRightclickedProcedure;
import net.createarmory.item.renderer.EmptyFourSixteenItemRenderer;
...
public class EmptyFourSixteenItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public EmptyFourSixteenItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyFourSixteenItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyFourSixteenItemRenderer renderer) {
	...
	public void setupAnimationState(EmptyFourSixteenItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyFourSixteenRightclickedProcedure.execute(world, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			EmptyMFourItemInHandTickProcedure.execute(world, entity);
	}
}
