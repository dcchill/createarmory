...
import net.createarmory.procedures.EmptyMFourRightclickedProcedure;
import net.createarmory.procedures.EmptyMFourItemInHandTickProcedure;
import net.createarmory.item.renderer.EmptyMFourItemRenderer;
...
public class EmptyMFourItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public EmptyMFourItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyMFourItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyMFourItemRenderer renderer) {
	...
	public void setupAnimationState(EmptyMFourItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyMFourRightclickedProcedure.execute(world, entity, itemstack);
		return ar;
	}
