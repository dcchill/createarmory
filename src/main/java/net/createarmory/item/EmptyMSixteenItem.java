...
import net.createarmory.procedures.EmptyMSixteenRightclickedProcedure;
import net.createarmory.procedures.EmptyMFourItemInHandTickProcedure;
import net.createarmory.item.renderer.EmptyMSixteenItemRenderer;
...
public class EmptyMSixteenItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public EmptyMSixteenItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyMSixteenItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyMSixteenItemRenderer renderer) {
	...
	public void setupAnimationState(EmptyMSixteenItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyMSixteenRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
