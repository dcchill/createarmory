...
import net.createarmory.procedures.EmptyMacTenRightclickedProcedure;
import net.createarmory.procedures.EmptyMacTenItemInHandTickProcedure;
import net.createarmory.item.renderer.EmptyMacTenItemRenderer;
...
public class EmptyMacTenItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public EmptyMacTenItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyMacTenItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyMacTenItemRenderer renderer) {
	...
	public void setupAnimationState(EmptyMacTenItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyMacTenRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			EmptyMacTenItemInHandTickProcedure.execute(world, entity);
	}
}
