...
import net.createarmory.procedures.EmptyPipePistolRightclickedProcedure;
import net.createarmory.item.renderer.EmptyPipePistolItemRenderer;
...
public class EmptyPipePistolItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public EmptyPipePistolItem() {
		super(new Item.Properties().tab(null).durability(650).rarity(Rarity.COMMON));
	}
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyPipePistolItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyPipePistolItemRenderer renderer) {
	...
	private <P extends Item & IAnimatable> PlayState idlePredicate(AnimationEvent<P> event) {
		if (this.transformType != null ? true : false) {
			if (this.animationprocedure.equals("empty")) {
				event.getController().setAnimation(new AnimationBuilder().addAnimation("idleclosed", EDefaultLoopTypes.LOOP));
	...
	public void setupAnimationState(EmptyPipePistolItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyPipePistolRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
