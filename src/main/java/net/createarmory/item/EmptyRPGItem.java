...
import net.createarmory.procedures.EmptyRPGRightclickedProcedure;
import net.createarmory.procedures.EmptyRPGItemInHandTickProcedure;
import net.createarmory.item.renderer.EmptyRPGItemRenderer;
...
public class EmptyRPGItem extends Item implements IAnimatable {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new EmptyRPGItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, EmptyRPGItemRenderer renderer) {
	...
	private <P extends Item & IAnimatable> PlayState idlePredicate(AnimationEvent<P> event) {
		if (this.transformType != null ? true : false) {
			if (this.animationprocedure.equals("empty")) {
				event.getController().setAnimation(new AnimationBuilder().addAnimation("empty", EDefaultLoopTypes.LOOP));
	...
	public void setupAnimationState(EmptyRPGItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		EmptyRPGRightclickedProcedure.execute(world, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			EmptyRPGItemInHandTickProcedure.execute(world, entity);
	}
}
