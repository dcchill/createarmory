...
import net.createarmory.procedures.FourSixteenRightclickedProcedure;
import net.createarmory.item.renderer.FourSixteenItemRenderer;
...
public class FourSixteenItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public FourSixteenItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new FourSixteenItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, FourSixteenItemRenderer renderer) {
	...
	public void setupAnimationState(FourSixteenItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		FourSixteenRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
