...
import net.createarmory.item.renderer.FourSixteenUpperItemRenderer;
...
public class FourSixteenUpperItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public FourSixteenUpperItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new FourSixteenUpperItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, FourSixteenUpperItemRenderer renderer) {
	...
	public void setupAnimationState(FourSixteenUpperItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
