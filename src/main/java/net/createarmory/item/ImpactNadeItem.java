...
import net.createarmory.procedures.ImpactNadeRightclickedProcedure;
import net.createarmory.item.renderer.ImpactNadeItemRenderer;
...
public class ImpactNadeItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public ImpactNadeItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new ImpactNadeItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, ImpactNadeItemRenderer renderer) {
	...
	public void setupAnimationState(ImpactNadeItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		ImpactNadeRightclickedProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
