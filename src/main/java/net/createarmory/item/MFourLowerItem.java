...
import net.createarmory.item.renderer.MFourLowerItemRenderer;
...
public class MFourLowerItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public MFourLowerItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new MFourLowerItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MFourLowerItemRenderer renderer) {
	...
	public void setupAnimationState(MFourLowerItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
