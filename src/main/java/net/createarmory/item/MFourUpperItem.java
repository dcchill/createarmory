...
import net.createarmory.item.renderer.MFourUpperItemRenderer;
...
public class MFourUpperItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public MFourUpperItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new MFourUpperItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MFourUpperItemRenderer renderer) {
	...
	public void setupAnimationState(MFourUpperItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
