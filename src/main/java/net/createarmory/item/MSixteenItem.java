...
import net.createarmory.procedures.MSixteenRigthclickedProcedure;
import net.createarmory.procedures.MFourItemInHandTickProcedure;
import net.createarmory.item.renderer.MSixteenItemRenderer;
...
public class MSixteenItem extends Item implements IAnimatable {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new MSixteenItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MSixteenItemRenderer renderer) {
	...
	public void setupAnimationState(MSixteenItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MSixteenRigthclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
