...
import net.createarmory.item.renderer.MSixteenUpperItemRenderer;
...
public class MSixteenUpperItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public MSixteenUpperItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new MSixteenUpperItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MSixteenUpperItemRenderer renderer) {
	...
	public void setupAnimationState(MSixteenUpperItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
