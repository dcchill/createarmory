...
import net.createarmory.procedures.MacTenRightclickedProcedure;
import net.createarmory.procedures.MacTenItemInHandTickProcedure;
import net.createarmory.item.renderer.MacTenItemRenderer;
...
public class MacTenItem extends Item implements IAnimatable {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new MacTenItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MacTenItemRenderer renderer) {
	...
	public void setupAnimationState(MacTenItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MacTenRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			MacTenItemInHandTickProcedure.execute(world, entity, itemstack);
	}
}
