...
import net.createarmory.item.renderer.MingunBaseItemRenderer;
...
public class MingunBaseItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public MingunBaseItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new MingunBaseItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MingunBaseItemRenderer renderer) {
	...
	public void setupAnimationState(MingunBaseItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
