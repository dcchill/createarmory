...
import net.createarmory.procedures.MiniGunRightclickedProcedure;
import net.createarmory.procedures.MiniGunItemInHandTickProcedure;
import net.createarmory.item.renderer.MiniGunItemRenderer;
...
public class MiniGunItem extends Item implements IAnimatable {
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MiniGunItemRenderer renderer) {
	...
	public void setupAnimationState(MiniGunItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		MiniGunRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
