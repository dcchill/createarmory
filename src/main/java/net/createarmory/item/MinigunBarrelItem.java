...
import net.createarmory.item.renderer.MinigunBarrelItemRenderer;
...
public class MinigunBarrelItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public MinigunBarrelItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new MinigunBarrelItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, MinigunBarrelItemRenderer renderer) {
	...
	public void setupAnimationState(MinigunBarrelItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
