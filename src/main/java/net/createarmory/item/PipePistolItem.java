...
import net.createarmory.procedures.PipePistolRightclickedProcedure;
import net.createarmory.item.renderer.PipePistolItemRenderer;
...
public class PipePistolItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public PipePistolItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new PipePistolItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, PipePistolItemRenderer renderer) {
	...
	public void setupAnimationState(PipePistolItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		PipePistolRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
