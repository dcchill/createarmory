...
import net.createarmory.procedures.RPGRightclickedProcedure;
import net.createarmory.procedures.RPGItemInHandTickProcedure;
import net.createarmory.item.renderer.RPGItemRenderer;
...
public class RPGItem extends Item implements IAnimatable {
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, RPGItemRenderer renderer) {
	...
	public void setupAnimationState(RPGItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		RPGRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			RPGItemInHandTickProcedure.execute(world, entity, itemstack);
	}
}
