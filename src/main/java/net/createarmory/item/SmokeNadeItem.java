...
import net.createarmory.procedures.SmokeNadeRightclickedProcedure;
import net.createarmory.item.renderer.SmokeNadeItemRenderer;
...
public class SmokeNadeItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public SmokeNadeItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new SmokeNadeItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, SmokeNadeItemRenderer renderer) {
	...
	public void setupAnimationState(SmokeNadeItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		SmokeNadeRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
