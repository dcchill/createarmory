...
import net.createarmory.procedures.UpgradedMiniGunRightclickedProcedure;
import net.createarmory.item.renderer.UpgradedMiniGunItemRenderer;
...
public class UpgradedMiniGunItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public UpgradedMiniGunItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new UpgradedMiniGunItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, UpgradedMiniGunItemRenderer renderer) {
	...
	public void setupAnimationState(UpgradedMiniGunItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A78Not so mini"));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		UpgradedMiniGunRightclickedProcedure.execute(world, x, y, z, entity, itemstack);
		return ar;
	}
}
