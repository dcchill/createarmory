...
import net.createarmory.procedures.MiniGunItemInHandTickProcedure;
import net.createarmory.item.renderer.UpgradedMinigunBarrelItemRenderer;
...
public class UpgradedMinigunBarrelItem extends Item implements IAnimatable {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	public String animationprocedure = "empty";
	public static ItemTransforms.TransformType transformType;

	public UpgradedMinigunBarrelItem() {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new UpgradedMinigunBarrelItemRenderer();
	...
	protected void interpretFirstPersonInstructions(List<String> tokens, UpgradedMinigunBarrelItemRenderer renderer) {
	...
	public void setupAnimationState(UpgradedMinigunBarrelItemRenderer renderer, ItemStack stack, PoseStack matrixStack, float aimProgress) {
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			MiniGunItemInHandTickProcedure.execute(world, entity);
	}
}
