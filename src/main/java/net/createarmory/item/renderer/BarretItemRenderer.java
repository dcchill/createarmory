...
import net.createarmory.item.model.BarretItemModel;
...
public class BarretItemRenderer extends GeoItemRenderer<BarretItem> implements RendersPlayerArms {
	public BarretItemRenderer() {
		super(new BarretItemModel());
	}

	@Override
	public RenderType getRenderType(BarretItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof BarretItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new BarretItemRenderer();
	...
	protected BarretItem animatable;
	...
	@Override
	public void render(GeoModel model, BarretItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(BarretItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(BarretItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(BarretItem animatable) {
