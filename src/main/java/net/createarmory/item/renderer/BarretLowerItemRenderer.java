...
import net.createarmory.item.model.BarretLowerItemModel;
...
public class BarretLowerItemRenderer extends GeoItemRenderer<BarretLowerItem> implements RendersPlayerArms {
	public BarretLowerItemRenderer() {
		super(new BarretLowerItemModel());
	}

	@Override
	public RenderType getRenderType(BarretLowerItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof BarretLowerItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new BarretLowerItemRenderer();
	...
	protected BarretLowerItem animatable;
	...
	@Override
	public void render(GeoModel model, BarretLowerItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(BarretLowerItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(BarretLowerItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(BarretLowerItem animatable) {
