...
import net.createarmory.item.model.BarretUpperItemModel;
...
public class BarretUpperItemRenderer extends GeoItemRenderer<BarretUpperItem> implements RendersPlayerArms {
	public BarretUpperItemRenderer() {
		super(new BarretUpperItemModel());
	}

	@Override
	public RenderType getRenderType(BarretUpperItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof BarretUpperItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new BarretUpperItemRenderer();
	...
	protected BarretUpperItem animatable;
	...
	@Override
	public void render(GeoModel model, BarretUpperItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(BarretUpperItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(BarretUpperItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(BarretUpperItem animatable) {
