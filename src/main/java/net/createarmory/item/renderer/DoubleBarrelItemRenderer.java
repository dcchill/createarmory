...
import net.createarmory.item.model.DoubleBarrelItemModel;
...
public class DoubleBarrelItemRenderer extends GeoItemRenderer<DoubleBarrelItem> implements RendersPlayerArms {
	public DoubleBarrelItemRenderer() {
		super(new DoubleBarrelItemModel());
	}

	@Override
	public RenderType getRenderType(DoubleBarrelItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof DoubleBarrelItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new DoubleBarrelItemRenderer();
	...
	@Override
	public void render(GeoModel model, DoubleBarrelItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(DoubleBarrelItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public Integer getUniqueID(DoubleBarrelItem animatable) {
