...
import net.createarmory.item.model.EmptyBarretItemModel;
...
public class EmptyBarretItemRenderer extends GeoItemRenderer<EmptyBarretItem> implements RendersPlayerArms {
	public EmptyBarretItemRenderer() {
		super(new EmptyBarretItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyBarretItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyBarretItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyBarretItemRenderer();
	...
	protected EmptyBarretItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyBarretItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(EmptyBarretItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyBarretItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyBarretItem animatable) {
