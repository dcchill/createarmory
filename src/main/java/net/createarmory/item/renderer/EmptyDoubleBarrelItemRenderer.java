...
import net.createarmory.item.model.EmptyDoubleBarrelItemModel;
...
public class EmptyDoubleBarrelItemRenderer extends GeoItemRenderer<EmptyDoubleBarrelItem> implements RendersPlayerArms {
	public EmptyDoubleBarrelItemRenderer() {
		super(new EmptyDoubleBarrelItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyDoubleBarrelItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyDoubleBarrelItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyDoubleBarrelItemRenderer();
	...
	protected EmptyDoubleBarrelItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyDoubleBarrelItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn,
	...
	@Override
	public void render(EmptyDoubleBarrelItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyDoubleBarrelItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyDoubleBarrelItem animatable) {
