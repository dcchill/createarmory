...
import net.createarmory.item.model.EmptyFourSixteenItemModel;
...
public class EmptyFourSixteenItemRenderer extends GeoItemRenderer<EmptyFourSixteenItem> implements RendersPlayerArms {
	public EmptyFourSixteenItemRenderer() {
		super(new EmptyFourSixteenItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyFourSixteenItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyFourSixteenItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyFourSixteenItemRenderer();
	...
	protected EmptyFourSixteenItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyFourSixteenItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(EmptyFourSixteenItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyFourSixteenItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyFourSixteenItem animatable) {
