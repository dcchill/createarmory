...
import net.createarmory.item.model.EmptyMFourItemModel;
...
public class EmptyMFourItemRenderer extends GeoItemRenderer<EmptyMFourItem> implements RendersPlayerArms {
	public EmptyMFourItemRenderer() {
		super(new EmptyMFourItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyMFourItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyMFourItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyMFourItemRenderer();
	...
	protected EmptyMFourItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyMFourItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(EmptyMFourItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyMFourItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyMFourItem animatable) {
