...
import net.createarmory.item.model.EmptyMSixteenItemModel;
...
public class EmptyMSixteenItemRenderer extends GeoItemRenderer<EmptyMSixteenItem> implements RendersPlayerArms {
	public EmptyMSixteenItemRenderer() {
		super(new EmptyMSixteenItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyMSixteenItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyMSixteenItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyMSixteenItemRenderer();
	...
	protected EmptyMSixteenItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyMSixteenItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(EmptyMSixteenItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyMSixteenItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyMSixteenItem animatable) {
