...
import net.createarmory.item.model.EmptyMacTenItemModel;
...
public class EmptyMacTenItemRenderer extends GeoItemRenderer<EmptyMacTenItem> implements RendersPlayerArms {
	public EmptyMacTenItemRenderer() {
		super(new EmptyMacTenItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyMacTenItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyMacTenItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyMacTenItemRenderer();
	...
	protected EmptyMacTenItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyMacTenItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(EmptyMacTenItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyMacTenItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyMacTenItem animatable) {
