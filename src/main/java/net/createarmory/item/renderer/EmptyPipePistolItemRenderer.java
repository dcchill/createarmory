...
import net.createarmory.item.model.EmptyPipePistolItemModel;
...
public class EmptyPipePistolItemRenderer extends GeoItemRenderer<EmptyPipePistolItem> implements RendersPlayerArms {
	public EmptyPipePistolItemRenderer() {
		super(new EmptyPipePistolItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyPipePistolItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyPipePistolItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyPipePistolItemRenderer();
	...
	protected EmptyPipePistolItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyPipePistolItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(EmptyPipePistolItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyPipePistolItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyPipePistolItem animatable) {
