...
import net.createarmory.item.model.EmptyRPGItemModel;
...
public class EmptyRPGItemRenderer extends GeoItemRenderer<EmptyRPGItem> implements RendersPlayerArms {
	public EmptyRPGItemRenderer() {
		super(new EmptyRPGItemModel());
	}

	@Override
	public RenderType getRenderType(EmptyRPGItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof EmptyRPGItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new EmptyRPGItemRenderer();
	...
	protected EmptyRPGItem animatable;
	...
	@Override
	public void render(GeoModel model, EmptyRPGItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(EmptyRPGItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(EmptyRPGItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(EmptyRPGItem animatable) {
