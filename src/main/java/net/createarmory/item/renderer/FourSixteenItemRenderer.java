...
import net.createarmory.item.model.FourSixteenItemModel;
...
public class FourSixteenItemRenderer extends GeoItemRenderer<FourSixteenItem> implements RendersPlayerArms {
	public FourSixteenItemRenderer() {
		super(new FourSixteenItemModel());
	}

	@Override
	public RenderType getRenderType(FourSixteenItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof FourSixteenItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new FourSixteenItemRenderer();
	...
	protected FourSixteenItem animatable;
	...
	@Override
	public void render(GeoModel model, FourSixteenItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(FourSixteenItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(FourSixteenItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(FourSixteenItem animatable) {
