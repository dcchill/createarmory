...
import net.createarmory.item.model.FourSixteenUpperItemModel;
...
public class FourSixteenUpperItemRenderer extends GeoItemRenderer<FourSixteenUpperItem> implements RendersPlayerArms {
	public FourSixteenUpperItemRenderer() {
		super(new FourSixteenUpperItemModel());
	}

	@Override
	public RenderType getRenderType(FourSixteenUpperItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof FourSixteenUpperItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new FourSixteenUpperItemRenderer();
	...
	protected FourSixteenUpperItem animatable;
	...
	@Override
	public void render(GeoModel model, FourSixteenUpperItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(FourSixteenUpperItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(FourSixteenUpperItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(FourSixteenUpperItem animatable) {
