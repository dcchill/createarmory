...
import net.createarmory.item.model.ImpactNadeItemModel;
...
public class ImpactNadeItemRenderer extends GeoItemRenderer<ImpactNadeItem> implements RendersPlayerArms {
	public ImpactNadeItemRenderer() {
		super(new ImpactNadeItemModel());
	}

	@Override
	public RenderType getRenderType(ImpactNadeItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof ImpactNadeItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new ImpactNadeItemRenderer();
	...
	protected ImpactNadeItem animatable;
	...
	@Override
	public void render(GeoModel model, ImpactNadeItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(ImpactNadeItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(ImpactNadeItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(ImpactNadeItem animatable) {
