...
import net.createarmory.item.model.MFourItemModel;
...
public class MFourItemRenderer extends GeoItemRenderer<MFourItem> implements RendersPlayerArms {
	public MFourItemRenderer() {
		super(new MFourItemModel());
	}

	@Override
	public RenderType getRenderType(MFourItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MFourItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MFourItemRenderer();
	...
	protected MFourItem animatable;
	...
	@Override
	public void render(GeoModel model, MFourItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MFourItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MFourItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MFourItem animatable) {
