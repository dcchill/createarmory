...
import net.createarmory.item.model.MFourLowerItemModel;
...
public class MFourLowerItemRenderer extends GeoItemRenderer<MFourLowerItem> implements RendersPlayerArms {
	public MFourLowerItemRenderer() {
		super(new MFourLowerItemModel());
	}

	@Override
	public RenderType getRenderType(MFourLowerItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MFourLowerItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MFourLowerItemRenderer();
	...
	protected MFourLowerItem animatable;
	...
	@Override
	public void render(GeoModel model, MFourLowerItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MFourLowerItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MFourLowerItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MFourLowerItem animatable) {
