...
import net.createarmory.item.model.MFourUpperItemModel;
...
public class MFourUpperItemRenderer extends GeoItemRenderer<MFourUpperItem> implements RendersPlayerArms {
	public MFourUpperItemRenderer() {
		super(new MFourUpperItemModel());
	}

	@Override
	public RenderType getRenderType(MFourUpperItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MFourUpperItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MFourUpperItemRenderer();
	...
	protected MFourUpperItem animatable;
	...
	@Override
	public void render(GeoModel model, MFourUpperItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MFourUpperItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MFourUpperItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MFourUpperItem animatable) {
