...
import net.createarmory.item.model.MSixteenItemModel;
...
public class MSixteenItemRenderer extends GeoItemRenderer<MSixteenItem> implements RendersPlayerArms {
	public MSixteenItemRenderer() {
		super(new MSixteenItemModel());
	}

	@Override
	public RenderType getRenderType(MSixteenItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MSixteenItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MSixteenItemRenderer();
	...
	protected MSixteenItem animatable;
	...
	@Override
	public void render(GeoModel model, MSixteenItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MSixteenItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MSixteenItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MSixteenItem animatable) {
