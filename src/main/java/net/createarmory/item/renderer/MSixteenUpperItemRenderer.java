...
import net.createarmory.item.model.MSixteenUpperItemModel;
...
public class MSixteenUpperItemRenderer extends GeoItemRenderer<MSixteenUpperItem> implements RendersPlayerArms {
	public MSixteenUpperItemRenderer() {
		super(new MSixteenUpperItemModel());
	}

	@Override
	public RenderType getRenderType(MSixteenUpperItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MSixteenUpperItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MSixteenUpperItemRenderer();
	...
	protected MSixteenUpperItem animatable;
	...
	@Override
	public void render(GeoModel model, MSixteenUpperItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MSixteenUpperItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MSixteenUpperItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MSixteenUpperItem animatable) {
