...
import net.createarmory.item.model.MacTenItemModel;
...
public class MacTenItemRenderer extends GeoItemRenderer<MacTenItem> implements RendersPlayerArms {
	public MacTenItemRenderer() {
		super(new MacTenItemModel());
	}

	@Override
	public RenderType getRenderType(MacTenItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MacTenItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MacTenItemRenderer();
	...
	protected MacTenItem animatable;
	...
	@Override
	public void render(GeoModel model, MacTenItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MacTenItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MacTenItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MacTenItem animatable) {
