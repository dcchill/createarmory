...
import net.createarmory.item.model.MingunBaseItemModel;
...
public class MingunBaseItemRenderer extends GeoItemRenderer<MingunBaseItem> implements RendersPlayerArms {
	public MingunBaseItemRenderer() {
		super(new MingunBaseItemModel());
	}

	@Override
	public RenderType getRenderType(MingunBaseItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MingunBaseItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MingunBaseItemRenderer();
	...
	protected MingunBaseItem animatable;
	...
	@Override
	public void render(GeoModel model, MingunBaseItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MingunBaseItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MingunBaseItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MingunBaseItem animatable) {
