...
import net.createarmory.item.model.MiniGunItemModel;
...
public class MiniGunItemRenderer extends GeoItemRenderer<MiniGunItem> implements RendersPlayerArms {
	public MiniGunItemRenderer() {
		super(new MiniGunItemModel());
	}

	@Override
	public RenderType getRenderType(MiniGunItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MiniGunItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MiniGunItemRenderer();
	...
	@Override
	public void render(GeoModel model, MiniGunItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MiniGunItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public Integer getUniqueID(MiniGunItem animatable) {
