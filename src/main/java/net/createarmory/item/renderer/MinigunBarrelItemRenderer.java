...
import net.createarmory.item.model.MinigunBarrelItemModel;
...
public class MinigunBarrelItemRenderer extends GeoItemRenderer<MinigunBarrelItem> implements RendersPlayerArms {
	public MinigunBarrelItemRenderer() {
		super(new MinigunBarrelItemModel());
	}

	@Override
	public RenderType getRenderType(MinigunBarrelItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof MinigunBarrelItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new MinigunBarrelItemRenderer();
	...
	protected MinigunBarrelItem animatable;
	...
	@Override
	public void render(GeoModel model, MinigunBarrelItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(MinigunBarrelItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(MinigunBarrelItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(MinigunBarrelItem animatable) {
