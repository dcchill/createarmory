...
import net.createarmory.item.model.RPGItemModel;
...
public class RPGItemRenderer extends GeoItemRenderer<RPGItem> implements RendersPlayerArms {
	public RPGItemRenderer() {
		super(new RPGItemModel());
	}

	@Override
	public RenderType getRenderType(RPGItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof RPGItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new RPGItemRenderer();
	...
	@Override
	public void render(GeoModel model, RPGItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red, float green,
	...
	@Override
	public void render(RPGItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public Integer getUniqueID(RPGItem animatable) {
