...
import net.createarmory.item.model.SmokeNadeItemModel;
...
public class SmokeNadeItemRenderer extends GeoItemRenderer<SmokeNadeItem> implements RendersPlayerArms {
	public SmokeNadeItemRenderer() {
		super(new SmokeNadeItemModel());
	}

	@Override
	public RenderType getRenderType(SmokeNadeItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof SmokeNadeItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new SmokeNadeItemRenderer();
	...
	protected SmokeNadeItem animatable;
	...
	@Override
	public void render(GeoModel model, SmokeNadeItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(SmokeNadeItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(SmokeNadeItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(SmokeNadeItem animatable) {
