...
import net.createarmory.item.model.UpgradedMiniGunItemModel;
...
public class UpgradedMiniGunItemRenderer extends GeoItemRenderer<UpgradedMiniGunItem> implements RendersPlayerArms {
	public UpgradedMiniGunItemRenderer() {
		super(new UpgradedMiniGunItemModel());
	}

	@Override
	public RenderType getRenderType(UpgradedMiniGunItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof UpgradedMiniGunItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new UpgradedMiniGunItemRenderer();
	...
	protected UpgradedMiniGunItem animatable;
	...
	@Override
	public void render(GeoModel model, UpgradedMiniGunItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn, float red,
	...
	@Override
	public void render(UpgradedMiniGunItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(UpgradedMiniGunItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(UpgradedMiniGunItem animatable) {
