...
import net.createarmory.item.model.UpgradedMinigunBarrelItemModel;
...
public class UpgradedMinigunBarrelItemRenderer extends GeoItemRenderer<UpgradedMinigunBarrelItem> implements RendersPlayerArms {
	public UpgradedMinigunBarrelItemRenderer() {
		super(new UpgradedMinigunBarrelItemModel());
	}

	@Override
	public RenderType getRenderType(UpgradedMinigunBarrelItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
		return RenderType.entityTranslucent(getTextureLocation(animatable));
	}

	static {
		AnimationController.addModelFetcher(animatable -> {
			if (animatable instanceof UpgradedMinigunBarrelItem) {
				Item item = (Item) animatable;
				BlockEntityWithoutLevelRenderer ister = new UpgradedMinigunBarrelItemRenderer();
	...
	protected UpgradedMinigunBarrelItem animatable;
	...
	@Override
	public void render(GeoModel model, UpgradedMinigunBarrelItem animatable, float partialTicks, RenderType type, PoseStack matrixStackIn, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, int packedOverlayIn,
	...
	@Override
	public void render(UpgradedMinigunBarrelItem animatable, PoseStack stack, MultiBufferSource bufferIn, int packedLightIn, ItemStack itemStack) {
	...
	@Override
	public ResourceLocation getTextureLocation(UpgradedMinigunBarrelItem instance) {
		return super.getTextureLocation(instance);
	}

	@Override
	public Integer getUniqueID(UpgradedMinigunBarrelItem animatable) {
