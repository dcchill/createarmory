...
public class FourSixteenRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (itemstack.getOrCreateTag().getBoolean("fireState") == false) {
			if (itemstack.getOrCreateTag().getDouble("ammoCount") <= 20) {
				if (itemstack.getItem() instanceof FourSixteenItem)
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.generic.explode")), SoundSource.PLAYERS, 1, Mth.nextInt(RandomSource.create(), (int) 1.6, (int) 1.7));
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.generic.explode")), SoundSource.PLAYERS, 1, Mth.nextInt(RandomSource.create(), (int) 1.6, (int) 1.7), false);
					}
				}
				if (world instanceof ServerLevel projectileLevel) {
					...
					}.getArrow(projectileLevel, entity, (float) 1.2, 1, (byte) 6);
					_entityToSpawn.setPos((entity.getX()), (entity.getY() + 1), (entity.getZ()));
					_entityToSpawn.shoot((entity.getLookAngle().x), (entity.getLookAngle().y), (entity.getLookAngle().z), (float) 9.2, (float) 1.8);
				...
				world.addParticle(ParticleTypes.CAMPFIRE_COSY_SMOKE, x, (y + 1), z, (entity.getLookAngle().x / 5), (entity.getLookAngle().y / 7), (entity.getLookAngle().z / 5));
				{
					...
					_ent.setXRot((float) (entity.getXRot() - Mth.nextDouble(RandomSource.create(), 0.3, 0.4)));
			...
			if (itemstack.getOrCreateTag().getDouble("ammoCount") <= 0) {
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == CreatearmoryModItems.FOUR_SIXTEEN.get()) {
					if (entity instanceof LivingEntity _entity) {
						ItemStack _setstack = new ItemStack(CreatearmoryModItems.EMPTY_FOUR_SIXTEEN.get());
						_setstack.setCount(1);
				...
				} else if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == CreatearmoryModItems.FOUR_SIXTEEN.get()) {
					if (entity instanceof LivingEntity _entity) {
						ItemStack _setstack = new ItemStack(CreatearmoryModItems.EMPTY_FOUR_SIXTEEN.get());
						_setstack.setCount(1);
