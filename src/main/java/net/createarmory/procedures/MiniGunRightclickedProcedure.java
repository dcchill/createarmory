...
public class MiniGunRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(CreatearmoryModItems.NINE_MM.get())) : false) == true) {
			...
			if (ninemm >= 4) {
				if (itemstack.getItem() instanceof MiniGunItem)
				...
				if (world instanceof Level _level) {
					if (!_level.isClientSide()) {
						_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.generic.explode")), SoundSource.PLAYERS, 1, Mth.nextInt(RandomSource.create(), (int) 1.8, 2));
					} else {
						_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.generic.explode")), SoundSource.PLAYERS, 1, Mth.nextInt(RandomSource.create(), (int) 1.8, 2), false);
					}
				}
				if (world instanceof ServerLevel projectileLevel) {
					...
					}.getArrow(projectileLevel, entity, (float) 2.5, (int) 0.2, (byte) 2);
				...
				entity.setDeltaMovement(new Vec3((entity.getLookAngle().x - entity.getLookAngle().x * 1.05), (entity.getLookAngle().y - entity.getLookAngle().y * 1.2), (entity.getLookAngle().z - entity.getLookAngle().z * 1.05)));
